...
#+RESULTS:
| sly-stickers-shortcut-mode | sly-trace-dialog-shortcut-mode | evil-normalize-keymaps | sly-setup-first-change-hook | sly--setup-completion | +common-lisp-init-sly-h |
...
(map! :leader
      (:prefix ("j" . "journal") ;; org-journal bindings
        ...
        (:prefix ("l" . "links")
                :desc "Insert/Edit link" "l" #'org-insert-link
                )
        (:prefix ("c" . "clock")
        ...
        (:prefix ("d" . "dates")
                ...
                :desc "Insert deadline" "d" #'org-deadline
                :desc "Insert schedule" "s" #'org-schedule
                )
        (:prefix ("p" . "properties")
